...
mod unit_test {
    ...
    fn parse_nodeinfo_2_1() {
        ...
        let json_str_3 = r##"{"metadata":{"enableGlobalTimeline":true,"enableGuestTimeline":false,"enableLocalTimeline":true,"enableRecommendedTimeline":false,"maintainer":{"name":"Javier Caceres"},"nodeDescription":"","nodeName":"Fedired","repositoryUrl":"https://github.com/fedired-dev/fedired","themeColor":"#F25A85"},"openRegistrations":false,"protocols":["activitypub"],"services":{"inbound":[],"outbound":["atom1.0","rss2.0"]},"software":{"homepage":"https://joinfedired.ort","name":"fedired","repository":"https://github.com/fedired/fedired","version":"1.2.0"},"usage":{"localPosts":23857,"users":{"activeHalfyear":7,"activeMonth":7,"total":9}},"version":"2.1"}"##;
        ...
        assert_eq!(parsed_3.software.version, "1.2.0-nvus.2.0");
